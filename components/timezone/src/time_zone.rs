...
use crate::{scaffold::IntoOption, Time, TimeZone, UtcOffset, TimeZoneVariant};
...
impl TimeZoneInfo<models::AtTime> {
    ...
    pub const fn with_zone_variant(self, zone_variant: TimeZoneVariant) -> TimeZoneInfo<models::Full> {
        TimeZoneInfo {
            offset: self.offset,
            time_zone_id: self.time_zone_id,
