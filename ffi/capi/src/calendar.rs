    ...
    impl Calendar {
        ...
        pub fn create(kind: CalendarKind) -> Box<Calendar> {
            Box::new(Calendar(match kind {
                ...
                #[allow(deprecated)]
                CalendarKind::Japanese | CalendarKind::JapaneseExtended => {
                ...
                #[allow(deprecated)]
                CalendarKind::HijriUmmAlQura | CalendarKind::HijriSimulatedMecca => {
                    CalendarInner::HijriUmmAlQura(icu_calendar::cal::Hijri::new_umm_al_qura())
                }
                CalendarKind::Julian => CalendarInner::Julian(icu_calendar::cal::Julian),
        ...
        pub fn create_with_provider(
            ...
            Ok(Box::new(Calendar(match kind {
                ...
                CalendarKind::Buddhist => CalendarInner::Buddhist(icu_calendar::cal::Buddhist),
                #[allow(deprecated)]
                CalendarKind::Japanese | CalendarKind::JapaneseExtended => CalendarInner::Japanese(
        ...
        pub fn kind(&self) -> CalendarKind {
            match &self.0 {
                ...
                CalendarInner::Julian(_) => CalendarKind::Julian,
...
icu_calendar::make_any_calendar!(
    ...
    Julian(icu_calendar::cal::Julian),
