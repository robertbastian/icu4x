...
pub mod versions {
    ...
    /// ```
    pub const fn cldr_tag() -> &'static str {
        crate::metadata::CLDR_JSON_GITREF
    }
    ...
    /// ```
    pub const fn icu_tag() -> &'static str {
        crate::metadata::ICUEXPORTDATA_GITREF
    }
}
...
/// ```
pub const fn locales() -> &'static [icu_locid::LanguageIdentifier] {
    crate::metadata::LOCALES
}
