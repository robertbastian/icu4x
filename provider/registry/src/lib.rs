...
macro_rules! registry(
    ($cb:ident) => {
        cb!(
            ...
            icu::normalizer::provider::CanonicalDecompositionDataV2Marker = "normalizer/nfd@2",
            icu::normalizer::provider::CanonicalDecompositionTablesV1Marker = "normalizer/nfdex@1",
            icu::normalizer::provider::CompatibilityDecompositionDataV2Marker = "normalizer/nfkd@2",
            ...
            icu::normalizer::provider::Uts46DecompositionDataV2Marker = "normalizer/uts46d@2",
