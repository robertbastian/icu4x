...
macro_rules! registry(
    ($cb:ident) => {
        cb!(
            ...
            icu::properties::provider::PropertyNameLongBlockV1: PropertyNameLongBlockV1,
            ...
            icu::properties::provider::PropertyNameParseBlockV1: PropertyNameParseBlockV1,
            ...
            icu::properties::provider::PropertyNameShortBlockV1: PropertyNameShortBlockV1,
            ...
            icu::properties::provider::PropertyEnumBlockV1: PropertyEnumBlockV1,
            ...
            icu::experimental::dimension::provider::currency::no_currency::CurrencyPatternsNoCurrencyV1: CurrencyPatternsNoCurrencyV1,
            ...
            icu::locale::provider::names::LocaleNamesRegionMediumTinyV1: LocaleNamesRegionMediumTinyV1,
            icu::locale::provider::names::LocaleNamesRegionMediumLightV1: LocaleNamesRegionMediumLightV1,
            icu::locale::provider::names::LocaleNamesRegionShortTinyV1: LocaleNamesRegionShortTinyV1,
            icu::locale::provider::names::LocaleNamesRegionShortLightV1: LocaleNamesRegionShortLightV1,
            icu::locale::provider::names::LocaleNamesLanguageMediumTinyV1: LocaleNamesLanguageMediumTinyV1,
            icu::locale::provider::names::LocaleNamesLanguageMediumLightV1: LocaleNamesLanguageMediumLightV1,
            icu::locale::provider::names::LocaleNamesLanguageMediumHeavyV1: LocaleNamesLanguageMediumHeavyV1,
            icu::locale::provider::names::LocaleNamesLanguageShortLightV1: LocaleNamesLanguageShortLightV1,
            icu::locale::provider::names::LocaleNamesLanguageShortHeavyV1: LocaleNamesLanguageShortHeavyV1,
            icu::locale::provider::names::LocaleNamesLanguageLongLightV1: LocaleNamesLanguageLongLightV1,
            icu::locale::provider::names::LocaleNamesLanguageLongHeavyV1: LocaleNamesLanguageLongHeavyV1,
            icu::locale::provider::names::LocaleNamesLanguageMenuMediumLightV1: LocaleNamesLanguageMenuMediumLightV1,
            icu::locale::provider::names::LocaleNamesLanguageMenuMediumHeavyV1: LocaleNamesLanguageMenuMediumHeavyV1,
            icu::locale::provider::names::LocaleNamesScriptMediumTinyV1: LocaleNamesScriptMediumTinyV1,
            icu::locale::provider::names::LocaleNamesScriptMediumLightV1: LocaleNamesScriptMediumLightV1,
            icu::locale::provider::names::LocaleNamesScriptMediumHeavyV1: LocaleNamesScriptMediumHeavyV1,
